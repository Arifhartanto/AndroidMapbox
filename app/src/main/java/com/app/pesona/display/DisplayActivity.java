package com.app.pesona.display;
...
import com.app.pesona.ManeuverMap;
import com.app.pesona.R;
...
import static com.app.pesona.Constants.MAPBOX_ACCESS_TOKEN;
import static com.app.pesona.Constants.MPH_DOUBLE;
...
public class DisplayActivity extends AppCompatActivity implements LocationEngineListener,
    ...
    private void initDistanceUtils() {
        ...
        distanceUtils = new DistanceUtils(this, language, DirectionsCriteria.PROFILE_DRIVING);
    }
    ...
    public String formatArrivalTime(double routeDurationRemaining) {
        ...
        return TimeUtils.formatTime(calendar, routeDurationRemaining,
                NavigationTimeFormat.TWENTY_FOUR_HOURS, isTwentyFourHourFormat);
    }
